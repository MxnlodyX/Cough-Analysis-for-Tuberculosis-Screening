"""
Implementation of a Mel-Spectrogram-based 2D-CNN model
...
Notes:
    - Based on the 2D-CNN architecture from Figure 5.
...
def train_fold(fi, cfg, cache_dir, sig, output_dir, run_tag, logger):
    ...
    model = TB_2DCNN().to(device) # เปลี่ยนโมเดล
